...
# we had some difficulties with the elx_fetch_data function where it would stop 
# and give an Internal Server Error (HTTP 500) error. Thus the work around was to run 
# the line with the given error seperatly which seemed to work and then proceed 
# after until that error occured again. and continued this proccedure. 
